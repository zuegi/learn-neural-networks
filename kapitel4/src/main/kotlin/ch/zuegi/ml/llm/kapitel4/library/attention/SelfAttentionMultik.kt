...
class SelfAttentionMultik(
    ...
    fun forward(input: NDArray<Double, D2>): NDArray<Double, D2> {
        ...
        val maskedScores = if (causal) maskCausal(scores) else scores
        val weights = softmaxRows(maskedScores)
