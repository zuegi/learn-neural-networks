...
import ch.zuegi.ml.llm.kapitel4.scratch.autograd.TransformerBlock
 ...
 *
 * Alle Gewichte sind lernbare [Tensor]-Parameter (via [parameters] fuer [ch.zuegi.ml.llm.kapitel4.scratch.autograd.SGD]).
